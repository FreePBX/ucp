...
<html>
	<head>
		...
		<script type="text/javascript" src="assets/framework/js/selector-set-1.0.4.min.js"></script>
		<script type="text/javascript" src="assets/framework/js/jquery.selector-set-0.1.5.min.js"></script>
		
		<link href="assets/css/compiled/<?php echo $ucpcssless?>" rel="stylesheet" type="text/css">
		
		<script src="assets/framework/js/bootstrap-3.0.2.custom.min.js"></script>
	...
	<body>
		<nav class="pushmenu pushmenu-left">
		    ...
		    <a href="#">Home</a>
		    <a href="#">VM <span class="badge">42</span></a>
		</nav>
